...
FROM         (SELECT     SUM(dbo.examen.prix) AS VALEUR, dbo.personne.nom AS nomPersonne, dbo.personne.postnom AS postNomPersonne, 
                   ...
                   WHERE      ((dbo.operation_laboratoire.etatpaiement = 'Non cloturé payé') OR
                                          (dbo.operation_laboratoire.etatpaiement = 'Cloturé payé')) AND categoriemalade.designation = 'Abonné' and etablissementpriseencharge.denomination='Echo Flight' and convert(date,operation_laboratoire.date,100) between '01/08/2015' and '04/08/2015'
                   ...
                   WHERE     ((dbo.subit.etatpaiement = 'Non cloturé payé') OR
                                         (dbo.subit.etatpaiement = 'Cloturé payé')) AND categoriemalade.designation = 'Abonné'    and etablissementpriseencharge.denomination='Echo Flight' and convert(date,subit.date,100) between '01/08/2015' and '04/08/2015'
                   ...
                   WHERE     dossierpreconsultation.etatpaiement = 'Fiche payée' AND categoriemalade.designation = 'Abonné' and etablissementpriseencharge.denomination='Echo Flight' and convert(date,dossierpreconsultation.date,100) between '01/08/2015' and '04/08/2015'
                   GROUP BY etablissementpriseencharge.denomination, dbo.personne.nom, dbo.personne.postnom, dbo.personne.prenom, dbo.malade.numero, 
                   ...
                   WHERE     ((dbo.consultation.etatpaiement = 'Non cloturé payé') OR
                                         (dbo.consultation.etatpaiement = 'Cloturé payé')) AND categoriemalade.designation = 'Abonné' and etablissementpriseencharge.denomination='Echo Flight' and convert(date,consultation.date,100) between '01/08/2015' and '04/08/2015'
                   GROUP BY etablissementpriseencharge.denomination, dbo.personne.nom, dbo.personne.postnom, dbo.personne.prenom, dbo.malade.numero, 
                                         consultation.date
                   UNION
                   ...
                   WHERE     ((dbo.dossierconsultationprenatale.etatpaiement = 'Non cloturé payé') OR
                                         (dbo.dossierconsultationprenatale.etatpaiement = 'Cloturé payé')) AND categoriemalade.designation = 'Abonné' and etablissementpriseencharge.denomination='Echo Flight' and convert(date,dossierconsultationprenatale.date,100) between '01/08/2015' and '04/08/2015'
                   GROUP BY etablissementpriseencharge.denomination, dbo.personne.nom, dbo.personne.postnom, dbo.personne.prenom, dbo.malade.numero, 
                   ...
                   WHERE     ((dbo.dossierechographie.etatpaiement = 'Non cloturé payé') OR
                                         (dbo.dossierechographie.etatpaiement = 'Cloturé payé')) AND categoriemalade.designation = 'Abonné' and etablissementpriseencharge.denomination='Echo Flight' and convert(date,dossierechographie.date,100) between '01/08/2015' and '04/08/2015'
                   GROUP BY etablissementpriseencharge.denomination, dbo.personne.nom, dbo.personne.postnom, dbo.personne.prenom, dbo.malade.numero, 
                   ...
                   WHERE     ((dbo.dossiersoin.etatpaiement = 'Non cloturé payé') OR
                                         (dbo.dossiersoin.etatpaiement = 'Cloturé payé')) AND categoriemalade.designation = 'Abonné' and etablissementpriseencharge.denomination='Echo Flight' and convert(date,dossiersoin.date,100) between '01/08/2015' and '04/08/2015'
                   GROUP BY etablissementpriseencharge.denomination, dbo.personne.nom, dbo.personne.postnom, dbo.personne.prenom, dbo.malade.numero, 
                                         dossiersoin.date
                   UNION
                   ...
                   WHERE     ((dbo.dossiernursing.etatpaiement = 'Non cloturé payé') OR
                                         (dbo.dossiernursing.etatpaiement = 'Cloturé payé')) AND categoriemalade.designation = 'Abonné' and etablissementpriseencharge.denomination='Echo Flight' and convert(date,dossiernursing.date,100) between '01/08/2015' and '04/08/2015'
                   GROUP BY etablissementpriseencharge.denomination, dbo.personne.nom, dbo.personne.postnom, dbo.personne.prenom, dbo.malade.numero, 
                                         dossiernursing.date
                   UNION
                   ...
                   WHERE     ((dbo.dossierconsultationgynecologique.etatpaiement = 'Non cloturé payé') OR
                                         (dbo.dossierconsultationgynecologique.etatpaiement = 'Cloturé payé')) AND categoriemalade.designation = 'Abonné' and etablissementpriseencharge.denomination='Echo Flight'  and convert(date,dossierconsultationgynecologique.date,100) between '01/08/2015' and '04/08/2015'
                   GROUP BY etablissementpriseencharge.denomination, dbo.personne.nom, dbo.personne.postnom, dbo.personne.prenom, dbo.malade.numero, 
                   ...
                   WHERE     ((dbo.dossierconsultationpostnatal.etatpaiement = 'Non cloturé payé') OR
                                         (dbo.dossierconsultationpostnatal.etatpaiement = 'Cloturé payé')) AND categoriemalade.designation = 'Abonné' and etablissementpriseencharge.denomination='Echo Flight' and convert(date,dossierconsultationpostnatal.date,100) between '01/08/2015' and '04/08/2015'
                   GROUP BY etablissementpriseencharge.denomination, dbo.personne.nom, dbo.personne.postnom, dbo.personne.prenom, dbo.malade.numero, 
                   ...
                   FROM         dbo.article INNER JOIN
                                         ...
                                         dbo.categoriemalade ON dbo.malade.id_categoriemalade = dbo.categoriemalade.id INNER JOIN
                                          dbo.etablissementpriseencharge ON malade.id_etablissement = etablissementpriseencharge.id
                   WHERE     (dbo.sortie.etatpaiement = 'Payé') AND categoriemalade.designation = 'Abonné' and etablissementpriseencharge.denomination='Echo Flight' and convert(date,sortie.date,100) between '01/08/2015' and '04/08/2015'
                   ...
                   FROM         dbo.detailsautrefraie INNER JOIN dbo.autrefraie ON dbo.autrefraie.id = dbo.detailsautrefraie.id_autrefraie RIGHT OUTER JOIN
                                         ...
                                         dbo.categoriemalade ON dbo.malade.id_categoriemalade = dbo.categoriemalade.id INNER JOIN
                                          dbo.etablissementpriseencharge ON malade.id_etablissement = etablissementpriseencharge.id
                   WHERE     (dbo.autrefraie.etatpaiement = 'Payé') AND categoriemalade.designation = 'Abonné' and etablissementpriseencharge.denomination='Echo Flight' and convert(date,autrefraie.dateenregistrement,100) between '01/08/2015' and '04/08/2015'
                   GROUP BY etablissementpriseencharge.denomination, dbo.personne.nom, dbo.personne.postnom, dbo.personne.prenom, dbo.malade.numero, 
