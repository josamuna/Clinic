...
{
    public partial class RecherchePersonneFemmeFrm : Form
    {
        public RecherchePersonneFemmeFrm()
        {
            InitializeComponent();
        }
        ...
        private void FrmRecherchePersonne_Load(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                bsrc_mal.DataSource = clsMetier.GetInstance().getAllClsmaladeDtFeminin();
            }
            catch (Exception ex) 
            {
        ...
        private void FrmRecherchePersonneFemme_FormClosing(object sender, FormClosingEventArgs e)
        {
            try
            {
                //Déchargement du BindingSource et DataGrid
