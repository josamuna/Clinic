...
{
    public partial class ChambresFrm : Form
    {
        public ChambresFrm()
        {
            InitializeComponent();
        ...
        private void FrmChambres_Load(object sender, EventArgs e)
        {
            lblAddCategorie.Enabled = false;
            try
            {
                bindingcls();
        ...
        private void cboCategorie_SelectedIndexChanged(object sender, EventArgs e)
        {
           if (!bln)
           {
               ...
               {
                   txtDesignation.Text = "Chambre" + " " + ((clscategoriechambre)cboCategorie.SelectedItem).Designation;
               }
           }
        }

        private void FrmChambres_FormClosing(object sender, FormClosingEventArgs e)
        {
            try
            {
