...
{
    public partial class MaladieFrm : Form
    {
        public MaladieFrm()
        {
            InitializeComponent();
        ...
        clsmaladie maladie = new clsmaladie();
        ...
        private void refresh()
        {
            try
            {
                bsrc.DataSource = clsMetier.GetInstance().getAllClsmaladie();
            }
            catch (Exception)
            {
        ...
        private void btnSave_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                else
                {
                    ...
                    {
                        clsmaladie s = (clsmaladie)bsrc.Current;
                        new clsmaladie().update(s);
                        MessageBox.Show("Modification effectuée!", "Modification", MessageBoxButtons.OK, MessageBoxIcon.Information);
                    }
                }
                //Permet l'actualisation des valeur des maladie sur le formulair appelant
                clsDoTraitement.EnterFormMaladie = true;
            }
            catch (Exception ex)
            {
        ...
        private void btnDelete_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (result == DialogResult.Yes)
                {
                    if (bsrc.DataSource != null)
                    {
                        clsmaladie d = (clsmaladie)bsrc.Current;
                        new clsmaladie().delete(d);
