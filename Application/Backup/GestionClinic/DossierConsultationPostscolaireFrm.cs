...
{
    public partial class DossierConsultationPostscolaireFrm : Form
    {
        public DossierConsultationPostscolaireFrm()
        {
            InitializeComponent();
        }
        ...
        private void FrmDossierConsultationPostscolaire_Load(object sender, EventArgs e)
        {
