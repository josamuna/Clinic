...
{
    public partial class MaladeGrosseUserFrm : UserControl
    {
        public MaladeGrosseUserFrm()
        {
            InitializeComponent();
        }
            ...
            try
            {
                ...
                else
                {
                    if (bsrc.DataSource != null)
                    {
                        ...
                        {
                            if (dtc.ToString().Equals("id")) s.IdFemmeEnceinte = ((int)obj[i]);
                            else if (dtc.ToString().Equals("id_malade")) s.Id_malade = ((int)obj[i]);
                            else if (dtc.ToString().Equals("conjoin")) s.Conjoin = ((obj[i]) == DBNull.Value) ? null : ((string)obj[i]);
                            else if (dtc.ToString().Equals("numeroregistre")) s.Numeroregistre = ((obj[i]) == DBNull.Value) ? null : ((string)obj[i]);
                            i++;
                        }
        ...
        private void FrmMaladeGrosseUser_Load(object sender, EventArgs e)
        {
