...
{
    public partial class RecherchePersonneMaladeFrm : Form
    {
        public RecherchePersonneMaladeFrm()
        {
            InitializeComponent();
        }
        ...
        private void FrmRecherchePersonneMalade_FormClosing(object sender, FormClosingEventArgs e)
        {
            try
            {
                //Déchargement du BindingSource et DataGrid
