...
{
    public partial class SortieArticleCaissePaiementFrm : UserControl
    {
        public SortieArticleCaissePaiementFrm()
        {
            InitializeComponent();
        }
        ...
        private void FrmApprovisionementMedicament_Load(object sender, EventArgs e)
        {
        ...
        private void lblAddArticle1_Click(object sender, EventArgs e)
        {
            new AutreFraieFrm().Show();
        }
