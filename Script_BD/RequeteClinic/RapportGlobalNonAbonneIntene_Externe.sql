           ...
           SELECT     nomPersonne, isnull(postNomPersonne, '-') AS postNomPersonne, isnull(prenomPersonne, '-') AS prenom,numero AS numero, dateEvent, SUM(isnull([examenP], 0)) AS resultatEx, SUM(isnull([ConsultationP], 0)) 
            ...
            FROM         (SELECT     SUM(dbo.examen.prix) AS VALEUR, dbo.personne.nom AS nomPersonne, dbo.personne.postnom AS postNomPersonne, 
                   ...
                   WHERE      ((dbo.operation_laboratoire.etatpaiement = 'Non cloturé payé') OR
                                          (dbo.operation_laboratoire.etatpaiement = 'Cloturé payé')) and (convert(date,operation_laboratoire.date,100)='20/08/2015')  and ((convert(date,hospitalisation.datefin,100)='20/08/2015') or (convert(date,dossieraccouchement.date,100)='20/08/2015')) and dbo.categoriemalade.designation='Non abonné'
                   GROUP BY dbo.personne.nom, dbo.personne.postnom, dbo.personne.prenom,dbo.malade.numero, operation_laboratoire.date
                   UNION
                   SELECT     SUM(dbo.examen.prix) AS VALEUR, dbo.personne.nom AS nomPersonne, dbo.personne.postnom AS postNomPersonne, 
                                          dbo.personne.prenom AS prenomPersonne,dbo.malade.numero AS numero,operation_laboratoire.date AS dateEvent, 'examenP' AS DIMENSION
                   FROM          dbo.examen INNER JOIN
                                          dbo.operation_laboratoire ON dbo.operation_laboratoire.id_examen = dbo.examen.id INNER JOIN
                                         ...
                                         dbo.categoriemalade ON dbo.malade.id_categoriemalade = dbo.categoriemalade.id
                   WHERE      ((dbo.operation_laboratoire.etatpaiement = 'Non cloturé payé') OR
                                          (dbo.operation_laboratoire.etatpaiement = 'Cloturé payé')) and (convert(date,operation_laboratoire.date,100)='20/08/2015')  and (malade.id not in(SELECT hospitalisation.id_malade FROM hospitalisation where (hospitalisation.id_malade in (select hospitalisation.id_malade from hospitalisation where (convert(date,hospitalisation.datefin,100)='20/08/2015'))))) and (malade.id not in(SELECT dossieraccouchement.id_malade FROM dossieraccouchement where (dossieraccouchement.id_malade in (select dossieraccouchement.id_malade from dossieraccouchement where (convert(date,dossieraccouchement.date,100)='20/08/2015'))))) and dbo.categoriemalade.designation='Non abonné'
                   GROUP BY dbo.personne.nom, dbo.personne.postnom, dbo.personne.prenom,dbo.malade.numero, operation_laboratoire.date
                   UNION
                   ...
                   WHERE     ((dbo.subit.etatpaiement = 'Non cloturé payé') OR
                                         (dbo.subit.etatpaiement = 'Cloturé payé')) and (convert(date,subit.date,100)='20/08/2015') and ((convert(date,hospitalisation.datefin,100)='20/08/2015') or (convert(date,dossieraccouchement.date,100)='20/08/2015')) and dbo.categoriemalade.designation='Non abonné'
                   ...
                   FROM         dbo.intervention INNER JOIN
                                         ...
                                         dbo.categoriemalade ON dbo.malade.id_categoriemalade = dbo.categoriemalade.id
                   WHERE     ((dbo.subit.etatpaiement = 'Non cloturé payé') OR
                                         (dbo.subit.etatpaiement = 'Cloturé payé')) and (convert(date,subit.date,100)='20/08/2015') and (malade.id not in(SELECT hospitalisation.id_malade FROM hospitalisation where (hospitalisation.id_malade in (select hospitalisation.id_malade from hospitalisation where (convert(date,hospitalisation.datefin,100)='20/08/2015'))))) and (malade.id not in(SELECT dossieraccouchement.id_malade FROM dossieraccouchement where (dossieraccouchement.id_malade in (select dossieraccouchement.id_malade from dossieraccouchement where (convert(date,dossieraccouchement.date,100)='20/08/2015'))))) and dbo.categoriemalade.designation='Non abonné'
                   GROUP BY dbo.personne.nom, dbo.personne.postnom, dbo.personne.prenom,dbo.malade.numero, subit.date
                   UNION
                   SELECT     SUM(dossierpreconsultation.cumul) AS VALEUR, dbo.personne.nom AS nomPersonne, dbo.personne.postnom AS postNomPersonne, 
                   ...
                   FROM         dossierpreconsultation INNER JOIN
                                         ...
                                         dbo.categoriemalade ON dbo.malade.id_categoriemalade = dbo.categoriemalade.id
                   WHERE     (dossierpreconsultation.etatpaiement = 'Fiche payée') and (convert(date,dossierpreconsultation.date,100) ='20/08/2015') and ((convert(date,hospitalisation.datefin,100)='20/08/2015') or (convert(date,dossieraccouchement.date,100)='20/08/2015')) and dbo.categoriemalade.designation='Non abonné'
                   ...
                   FROM         dossierpreconsultation INNER JOIN
                                         ...
                                         tarifpreconsultation ON dossierpreconsultation.id_tarifpreconsultation = tarifpreconsultation.id INNER JOIN
                                         dbo.categoriemalade ON dbo.malade.id_categoriemalade = dbo.categoriemalade.id
                   WHERE     (dossierpreconsultation.etatpaiement = 'Fiche payée') and (convert(date,dossierpreconsultation.date,100) ='20/08/2015') and (malade.id not in(SELECT hospitalisation.id_malade FROM hospitalisation where (hospitalisation.id_malade in (select hospitalisation.id_malade from hospitalisation where (convert(date,hospitalisation.datefin,100)='20/08/2015'))))) and (malade.id not in(SELECT dossieraccouchement.id_malade FROM dossieraccouchement where (dossieraccouchement.id_malade in (select dossieraccouchement.id_malade from dossieraccouchement where (convert(date,dossieraccouchement.date,100)='20/08/2015'))))) and dbo.categoriemalade.designation='Non abonné'
                   GROUP BY dbo.personne.nom, dbo.personne.postnom, dbo.personne.prenom,dbo.malade.numero, dossierpreconsultation.date
                   UNION
                   ...
                   WHERE     ((dbo.consultation.etatpaiement = 'Non cloturé payé') OR
                                         (dbo.consultation.etatpaiement = 'Cloturé payé')) and (convert(date,consultation.date,100) ='20/08/2015') and ((convert(date,hospitalisation.datefin,100)='20/08/2015') or (convert(date,dossieraccouchement.date,100)='20/08/2015')) and dbo.categoriemalade.designation='Non abonné'
                   ...
                   FROM         dbo.tarifconsultation INNER JOIN
                                         ...
                                         dbo.categoriemalade ON dbo.malade.id_categoriemalade = dbo.categoriemalade.id
                   WHERE     ((dbo.consultation.etatpaiement = 'Non cloturé payé') OR
                                         (dbo.consultation.etatpaiement = 'Cloturé payé')) and (convert(date,consultation.date,100) ='20/08/2015') and (malade.id not in(SELECT hospitalisation.id_malade FROM hospitalisation where (hospitalisation.id_malade in (select hospitalisation.id_malade from hospitalisation where (convert(date,hospitalisation.datefin,100)='20/08/2015'))))) and (malade.id not in(SELECT dossieraccouchement.id_malade FROM dossieraccouchement where (dossieraccouchement.id_malade in (select dossieraccouchement.id_malade from dossieraccouchement where (convert(date,dossieraccouchement.date,100)='20/08/2015'))))) and dbo.categoriemalade.designation='Non abonné'
                   GROUP BY dbo.personne.nom, dbo.personne.postnom, dbo.personne.prenom,dbo.malade.numero, consultation.date
                   UNION
                   ...
                   WHERE     ((dbo.dossierconsultationprenatale.etatpaiement = 'Non cloturé payé') OR
                                         (dbo.dossierconsultationprenatale.etatpaiement = 'Cloturé payé')) and (convert(date,dossierconsultationprenatale.date,100) ='20/08/2015') and ((convert(date,hospitalisation.datefin,100)='20/08/2015') or (convert(date,dossieraccouchement.date,100)='20/08/2015')) and dbo.categoriemalade.designation='Non abonné'
                   ...
                   FROM         dbo.tarifconsultationprenatal INNER JOIN
                                         ...
                                         dbo.categoriemalade ON dbo.malade.id_categoriemalade = dbo.categoriemalade.id
                   WHERE     ((dbo.dossierconsultationprenatale.etatpaiement = 'Non cloturé payé') OR
                                         (dbo.dossierconsultationprenatale.etatpaiement = 'Cloturé payé')) and (convert(date,dossierconsultationprenatale.date,100) ='20/08/2015') and (malade.id not in(SELECT hospitalisation.id_malade FROM hospitalisation where (hospitalisation.id_malade in (select hospitalisation.id_malade from hospitalisation where (convert(date,hospitalisation.datefin,100)='20/08/2015'))))) and (malade.id not in(SELECT dossieraccouchement.id_malade FROM dossieraccouchement where (dossieraccouchement.id_malade in (select dossieraccouchement.id_malade from dossieraccouchement where (convert(date,dossieraccouchement.date,100)='20/08/2015'))))) and dbo.categoriemalade.designation='Non abonné'
                   GROUP BY dbo.personne.nom, dbo.personne.postnom, dbo.personne.prenom,dbo.malade.numero, dossierconsultationprenatale.date
                   UNION
                   ...
                   WHERE     ((dbo.dossierechographie.etatpaiement = 'Non cloturé payé') OR
                                         (dbo.dossierechographie.etatpaiement = 'Cloturé payé')) and (convert(date,dossierechographie.date,100)='20/08/2015') and ((convert(date,hospitalisation.datefin,100)='20/08/2015') or (convert(date,dossieraccouchement.date,100)='20/08/2015')) and dbo.categoriemalade.designation='Non abonné'
                   ...
                   FROM         dbo.tarifechographie INNER JOIN
                                         ...
                                         dbo.categoriemalade ON dbo.malade.id_categoriemalade = dbo.categoriemalade.id
                   WHERE     ((dbo.dossierechographie.etatpaiement = 'Non cloturé payé') OR
                                         (dbo.dossierechographie.etatpaiement = 'Cloturé payé')) and (convert(date,dossierechographie.date,100)='20/08/2015') and (malade.id not in(SELECT hospitalisation.id_malade FROM hospitalisation where (hospitalisation.id_malade in (select hospitalisation.id_malade from hospitalisation where (convert(date,hospitalisation.datefin,100)='20/08/2015'))))) and (malade.id not in(SELECT dossieraccouchement.id_malade FROM dossieraccouchement where (dossieraccouchement.id_malade in (select dossieraccouchement.id_malade from dossieraccouchement where (convert(date,dossieraccouchement.date,100)='20/08/2015'))))) and dbo.categoriemalade.designation='Non abonné'
                   GROUP BY dbo.personne.nom, dbo.personne.postnom, dbo.personne.prenom,dbo.malade.numero, dossierechographie.date
                   UNION
                   ...
                   WHERE     ((dbo.dossiersoin.etatpaiement = 'Non cloturé payé') OR
                                         (dbo.dossiersoin.etatpaiement = 'Cloturé payé')) and (convert(date,dossiersoin.date,100)='20/08/2015') and ((convert(date,hospitalisation.datefin,100)='20/08/2015') or (convert(date,dossieraccouchement.date,100)='20/08/2015')) and dbo.categoriemalade.designation='Non abonné'
                   ...
                   FROM         dbo.tarifsoin INNER JOIN
                                         ...
                                         dbo.categoriemalade ON dbo.malade.id_categoriemalade = dbo.categoriemalade.id
                   WHERE     ((dbo.dossiersoin.etatpaiement = 'Non cloturé payé') OR
                                         (dbo.dossiersoin.etatpaiement = 'Cloturé payé')) and (convert(date,dossiersoin.date,100)='20/08/2015') and (malade.id not in(SELECT hospitalisation.id_malade FROM hospitalisation where (hospitalisation.id_malade in (select hospitalisation.id_malade from hospitalisation where (convert(date,hospitalisation.datefin,100)='20/08/2015'))))) and (malade.id not in(SELECT dossieraccouchement.id_malade FROM dossieraccouchement where (dossieraccouchement.id_malade in (select dossieraccouchement.id_malade from dossieraccouchement where (convert(date,dossieraccouchement.date,100)='20/08/2015'))))) and dbo.categoriemalade.designation='Non abonné'
                   GROUP BY dbo.personne.nom, dbo.personne.postnom, dbo.personne.prenom,dbo.malade.numero, dossiersoin.date 
                   UNION
                   ...
                   WHERE     ((dbo.dossiernursing.etatpaiement = 'Non cloturé payé') OR
                                         (dbo.dossiernursing.etatpaiement = 'Cloturé payé')) and (convert(date,dossiernursing.date,100)='20/08/2015') and ((convert(date,hospitalisation.datefin,100)='20/08/2015') or (convert(date,dossieraccouchement.date,100)='20/08/2015')) and dbo.categoriemalade.designation='Non abonné'
                   ...
                   FROM         dbo.tarifnursing INNER JOIN
                                         ...
                                         dbo.categoriemalade ON dbo.malade.id_categoriemalade = dbo.categoriemalade.id
                   WHERE     ((dbo.dossiernursing.etatpaiement = 'Non cloturé payé') OR
                                         (dbo.dossiernursing.etatpaiement = 'Cloturé payé')) and (convert(date,dossiernursing.date,100)='20/08/2015') and (malade.id not in(SELECT hospitalisation.id_malade FROM hospitalisation where (hospitalisation.id_malade in (select hospitalisation.id_malade from hospitalisation where (convert(date,hospitalisation.datefin,100)='20/08/2015'))))) and (malade.id not in(SELECT dossieraccouchement.id_malade FROM dossieraccouchement where (dossieraccouchement.id_malade in (select dossieraccouchement.id_malade from dossieraccouchement where (convert(date,dossieraccouchement.date,100)='20/08/2015'))))) and dbo.categoriemalade.designation='Non abonné'
                   GROUP BY dbo.personne.nom, dbo.personne.postnom, dbo.personne.prenom,dbo.malade.numero, dossiernursing.date             
                   UNION
                   ...
                   WHERE     ((dbo.dossierconsultationgynecologique.etatpaiement = 'Non cloturé payé') OR
                                         (dbo.dossierconsultationgynecologique.etatpaiement = 'Cloturé payé')) and (convert(date,dossierconsultationgynecologique.date,100)='20/08/2015') and ((convert(date,hospitalisation.datefin,100)='20/08/2015') or (convert(date,dossieraccouchement.date,100)='20/08/2015')) and dbo.categoriemalade.designation='Non abonné'
                   ...
                   FROM         dbo.tarifconsultationgynecologique INNER JOIN
                                         ...
                                         dbo.categoriemalade ON dbo.malade.id_categoriemalade = dbo.categoriemalade.id 
                   WHERE     ((dbo.dossierconsultationgynecologique.etatpaiement = 'Non cloturé payé') OR
                                         (dbo.dossierconsultationgynecologique.etatpaiement = 'Cloturé payé')) and (convert(date,dossierconsultationgynecologique.date,100)='20/08/2015') and (malade.id not in(SELECT hospitalisation.id_malade FROM hospitalisation where (hospitalisation.id_malade in (select hospitalisation.id_malade from hospitalisation where (convert(date,hospitalisation.datefin,100)='20/08/2015'))))) and (malade.id not in(SELECT dossieraccouchement.id_malade FROM dossieraccouchement where (dossieraccouchement.id_malade in (select dossieraccouchement.id_malade from dossieraccouchement where (convert(date,dossieraccouchement.date,100)='20/08/2015'))))) and dbo.categoriemalade.designation='Non abonné'
                   GROUP BY dbo.personne.nom, dbo.personne.postnom, dbo.personne.prenom, dbo.malade.numero,dossierconsultationgynecologique.date
                   UNION
                   ...
                   WHERE     ((dbo.dossierconsultationpostnatal.etatpaiement = 'Non cloturé payé') OR
                                         (dbo.dossierconsultationpostnatal.etatpaiement = 'Cloturé payé')) and (convert(date,dossierconsultationpostnatal.date,100)='20/08/2015') and ((convert(date,hospitalisation.datefin,100)='20/08/2015') or (convert(date,dossieraccouchement.date,100)='20/08/2015')) and dbo.categoriemalade.designation='Non abonné'
                   ...
                   FROM         dbo.tarifconsultationpostnatal INNER JOIN
                                         ...
                                         dbo.categoriemalade ON dbo.malade.id_categoriemalade = dbo.categoriemalade.id
                   WHERE     ((dbo.dossierconsultationpostnatal.etatpaiement = 'Non cloturé payé') OR
                                         (dbo.dossierconsultationpostnatal.etatpaiement = 'Cloturé payé')) and (convert(date,dossierconsultationpostnatal.date,100)='20/08/2015') and (malade.id not in(SELECT hospitalisation.id_malade FROM hospitalisation where (hospitalisation.id_malade in (select hospitalisation.id_malade from hospitalisation where (convert(date,hospitalisation.datefin,100)='20/08/2015'))))) and (malade.id not in(SELECT dossieraccouchement.id_malade FROM dossieraccouchement where (dossieraccouchement.id_malade in (select dossieraccouchement.id_malade from dossieraccouchement where (convert(date,dossieraccouchement.date,100)='20/08/2015'))))) and dbo.categoriemalade.designation='Non abonné'
                   GROUP BY dbo.personne.nom, dbo.personne.postnom, dbo.personne.prenom,dbo.malade.numero, dossierconsultationpostnatal.date
                   UNION
                   ...
                   FROM         dbo.typeaccouchement INNER JOIN
                                         ...
                                         dbo.personne ON dbo.malade.id_personne = dbo.personne.id RIGHT OUTER JOIN
                                         dbo.categoriemalade ON dbo.malade.id_categoriemalade = dbo.categoriemalade.id
                   WHERE     ((dbo.dossieraccouchement.etatpaiement = 'Non cloturé payé') OR (dbo.dossieraccouchement.etatpaiement = 'Cloturé payé')) and convert(date,dossieraccouchement.date,100)='20/08/2015' and dbo.categoriemalade.designation='Non abonné'
                   GROUP BY dbo.personne.nom, dbo.personne.postnom, dbo.personne.prenom, dbo.malade.numero,dossieraccouchement.date
                   UNION
                   SELECT     SUM(dbo.article.pu*dbo.sortie.quantinte) AS VALEUR, dbo.personne.nom AS nomPersonne, dbo.personne.postnom AS postNomPersonne, 
                   ...
                   FROM         dbo.article INNER JOIN
                                         ...
                                         dbo.dossieraccouchement ON dbo.malade.id = dbo.dossieraccouchement.id_malade FULL OUTER JOIN
                                          ...
                                          dbo.personne ON dbo.malade.id_personne = dbo.personne.id INNER JOIN
                                         dbo.categoriemalade ON dbo.malade.id_categoriemalade = dbo.categoriemalade.id
                   WHERE     (dbo.sortie.etatpaiement = 'Payé') and (convert(date,sortie.date,100)='20/08/2015') and ((convert(date,hospitalisation.datefin,100)='20/08/2015') or (convert(date,dossieraccouchement.date,100)='20/08/2015')) and dbo.categoriemalade.designation='Non abonné'
                   ...
                   FROM         dbo.article INNER JOIN
                                         ...
                                         dbo.malade ON dbo.malade.id = dbo.sortie.id_malade INNER JOIN 
                                          dbo.personne ON dbo.malade.id_personne = dbo.personne.id INNER JOIN
                                         dbo.categoriemalade ON dbo.malade.id_categoriemalade = dbo.categoriemalade.id
                   WHERE     (dbo.sortie.etatpaiement = 'Payé') and (convert(date,sortie.date,100)='20/08/2015') and (malade.id not in(SELECT hospitalisation.id_malade FROM hospitalisation where (hospitalisation.id_malade in (select hospitalisation.id_malade from hospitalisation where (convert(date,hospitalisation.datefin,100)='20/08/2015'))))) and (malade.id not in(SELECT dossieraccouchement.id_malade FROM dossieraccouchement where (dossieraccouchement.id_malade in (select dossieraccouchement.id_malade from dossieraccouchement where (convert(date,dossieraccouchement.date,100)='20/08/2015'))))) and dbo.categoriemalade.designation='Non abonné'
                   GROUP BY dbo.personne.nom, dbo.personne.postnom, dbo.personne.prenom,dbo.malade.numero, sortie.date
                   UNION
                   ...
                   FROM         dbo.detailsautrefraie INNER JOIN dbo.autrefraie ON dbo.autrefraie.id = dbo.detailsautrefraie.id_autrefraie INNER JOIN
                                         ...
                                         dbo.dossieraccouchement ON dbo.malade.id = dbo.dossieraccouchement.id_malade FULL OUTER JOIN
                                          ...
                                          dbo.personne ON dbo.malade.id_personne = dbo.personne.id INNER JOIN
                                         dbo.categoriemalade ON dbo.malade.id_categoriemalade = dbo.categoriemalade.id
                   WHERE     (dbo.autrefraie.etatpaiement = 'Payé') and (convert(date,autrefraie.dateenregistrement,100)='20/08/2015') and ((convert(date,hospitalisation.datefin,100)='20/08/2015') or (convert(date,dossieraccouchement.date,100)='20/08/2015')) and dbo.categoriemalade.designation='Non abonné'
                   ...
                   FROM         dbo.detailsautrefraie INNER JOIN dbo.autrefraie ON dbo.autrefraie.id = dbo.detailsautrefraie.id_autrefraie INNER JOIN
                                         dbo.malade ON dbo.malade.id = dbo.autrefraie.id_malade INNER JOIN 
                                          dbo.personne ON dbo.malade.id_personne = dbo.personne.id INNER JOIN
                                         dbo.categoriemalade ON dbo.malade.id_categoriemalade = dbo.categoriemalade.id
                   WHERE     (dbo.autrefraie.etatpaiement = 'Payé') and (convert(date,autrefraie.dateenregistrement,100)='20/08/2015') and (malade.id not in(SELECT hospitalisation.id_malade FROM hospitalisation where (hospitalisation.id_malade in (select hospitalisation.id_malade from hospitalisation where (convert(date,hospitalisation.datefin,100)='20/08/2015'))))) and (malade.id not in(SELECT dossieraccouchement.id_malade FROM dossieraccouchement where (dossieraccouchement.id_malade in (select dossieraccouchement.id_malade from dossieraccouchement where (convert(date,dossieraccouchement.date,100)='20/08/2015'))))) and dbo.categoriemalade.designation='Non abonné'
                   GROUP BY dbo.personne.nom, dbo.personne.postnom, dbo.personne.prenom,dbo.malade.numero, autrefraie.dateenregistrement
                   UNION
                   SELECT     SUM(dbo.categoriechambre.prix*ISNULL(DATEDIFF(DAY,hospitalisation.datedebut,hospitalisation.datefin),0)) AS VALEUR, dbo.personne.nom AS nomPersonne, dbo.personne.postnom AS postNomPersonne, 
                   ...
                   WHERE     ((dbo.hospitalisation.etatpaiement = 'Non cloturé payé') OR
                                         (dbo.hospitalisation.etatpaiement = 'Cloturé payé')) and (convert(date,hospitalisation.datefin,100)='20/08/2015') and dbo.categoriemalade.designation='Non abonné'
                   ...
                   WHERE     ((dbo.dossieravance.etatpaiement = 'Non cloturé payé') OR
                                         (dbo.dossieravance.etatpaiement = 'Cloturé payé')) and (convert(date,dossieravance.date,100)='20/08/2015') and ((convert(date,hospitalisation.datefin,100)='20/08/2015') or (convert(date,dossieraccouchement.date,100)='20/08/2015')) and dbo.categoriemalade.designation='Non abonné'
                   ...
                   FROM         dbo.malade_avance INNER JOIN											 
                                         ...
                                         dbo.categoriemalade ON dbo.malade.id_categoriemalade = dbo.categoriemalade.id
                   WHERE     ((dbo.dossieravance.etatpaiement = 'Non cloturé payé') OR
                                         (dbo.dossieravance.etatpaiement = 'Cloturé payé')) and (convert(date,dossieravance.date,100)='20/08/2015') and (malade.id not in(SELECT hospitalisation.id_malade FROM hospitalisation where (hospitalisation.id_malade in (select hospitalisation.id_malade from hospitalisation where (convert(date,hospitalisation.datefin,100)='20/08/2015'))))) and (malade.id not in(SELECT dossieraccouchement.id_malade FROM dossieraccouchement where (dossieraccouchement.id_malade in (select dossieraccouchement.id_malade from dossieraccouchement where (convert(date,dossieraccouchement.date,100)='20/08/2015'))))) and dbo.categoriemalade.designation='Non abonné'
