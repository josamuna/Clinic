           ...
           SELECT     nomPersonne, isnull(postNomPersonne, '-') AS postNomPersonne, isnull(prenomPersonne, '-') AS prenom,numero AS numero, dateEvent, SUM(isnull([examenP], 0)) AS resultatEx, SUM(isnull([ConsultationP], 0)) 
            ...
            FROM         (SELECT     SUM(dbo.examen.prix) AS VALEUR, dbo.personne.nom AS nomPersonne, dbo.personne.postnom AS postNomPersonne, 
                   ...
                   WHERE      ((dbo.operation_laboratoire.etatpaiement = 'Non cloturé payé') OR
                                          (dbo.operation_laboratoire.etatpaiement = 'Cloturé payé')) and (convert(date,operation_laboratoire.date,100)='03/08/2015')  and convert(date,hospitalisation.datefin,100)='03/08/2015' and dbo.categoriemalade.designation='Abonné'
                   ...
                   WHERE     ((dbo.subit.etatpaiement = 'Non cloturé payé') OR
                                         (dbo.subit.etatpaiement = 'Cloturé payé')) and (convert(date,subit.date,100)='03/08/2015') and convert(date,hospitalisation.datefin,100)='03/08/2015' and dbo.categoriemalade.designation='Abonné'
                   ...
                   FROM         dossierpreconsultation INNER JOIN
                                         ...
                                         dbo.categoriemalade ON dbo.malade.id_categoriemalade = dbo.categoriemalade.id
                   WHERE     (dossierpreconsultation.etatpaiement = 'Fiche payée') and (convert(date,dossierpreconsultation.date,100) ='03/08/2015') and convert(date,hospitalisation.datefin,100)='03/08/2015' and dbo.categoriemalade.designation='Abonné'
                   ...
                   WHERE     ((dbo.consultation.etatpaiement = 'Non cloturé payé') OR
                                         (dbo.consultation.etatpaiement = 'Cloturé payé')) and (convert(date,consultation.date,100) ='03/08/2015') and convert(date,hospitalisation.datefin,100)='03/08/2015' and dbo.categoriemalade.designation='Abonné'
                   ...
                   WHERE     ((dbo.dossierconsultationprenatale.etatpaiement = 'Non cloturé payé') OR
                                         (dbo.dossierconsultationprenatale.etatpaiement = 'Cloturé payé')) and (convert(date,dossierconsultationprenatale.date,100) ='03/08/2015') and convert(date,hospitalisation.datefin,100)='03/08/2015' and dbo.categoriemalade.designation='Abonné'
                   ...
                   WHERE     ((dbo.dossierechographie.etatpaiement = 'Non cloturé payé') OR
                                         (dbo.dossierechographie.etatpaiement = 'Cloturé payé')) and (convert(date,dossierechographie.date,100)='03/08/2015') and convert(date,hospitalisation.datefin,100)='03/08/2015' and dbo.categoriemalade.designation='Abonné'
                   ...
                   WHERE     ((dbo.dossiersoin.etatpaiement = 'Non cloturé payé') OR
                                         (dbo.dossiersoin.etatpaiement = 'Cloturé payé')) and (convert(date,dossiersoin.date,100)='03/08/2015') and convert(date,hospitalisation.datefin,100)='03/08/2015' and dbo.categoriemalade.designation='Abonné'
                   ...
                   WHERE     ((dbo.dossiernursing.etatpaiement = 'Non cloturé payé') OR
                                         (dbo.dossiernursing.etatpaiement = 'Cloturé payé')) and (convert(date,dossiernursing.date,100)='03/08/2015') and convert(date,hospitalisation.datefin,100)='03/08/2015' and dbo.categoriemalade.designation='Abonné'
                   ...
                   WHERE     ((dbo.dossierconsultationgynecologique.etatpaiement = 'Non cloturé payé') OR
                                         (dbo.dossierconsultationgynecologique.etatpaiement = 'Cloturé payé')) and (convert(date,dossierconsultationgynecologique.date,100)='03/08/2015') and convert(date,hospitalisation.datefin,100)='03/08/2015' and dbo.categoriemalade.designation='Abonné'
                   ...
                   WHERE     ((dbo.dossierconsultationpostnatal.etatpaiement = 'Non cloturé payé') OR
                                         (dbo.dossierconsultationpostnatal.etatpaiement = 'Cloturé payé')) and (convert(date,dossierconsultationpostnatal.date,100)='03/08/2015') and convert(date,hospitalisation.datefin,100)='03/08/2015' and dbo.categoriemalade.designation='Abonné'
                   ...
                   FROM         dbo.typeaccouchement INNER JOIN
                                         ...
                                         dbo.personne ON dbo.malade.id_personne = dbo.personne.id LEFT OUTER JOIN
                                         dbo.categoriemalade ON dbo.malade.id_categoriemalade = dbo.categoriemalade.id
                   WHERE     ((dbo.dossieraccouchement.etatpaiement = 'Non cloturé payé') OR (dbo.dossieraccouchement.etatpaiement = 'Cloturé payé')) and convert(date,dossieraccouchement.date,100)='03/08/2015' and dbo.categoriemalade.designation='Abonné'
                   ...
                   FROM         dbo.article INNER JOIN
                                         ...
                                         dbo.malade ON dbo.malade.id = dbo.sortie.id_malade INNER JOIN 
                                          ...
                                          dbo.personne ON dbo.malade.id_personne = dbo.personne.id LEFT OUTER JOIN
                                         dbo.categoriemalade ON dbo.malade.id_categoriemalade = dbo.categoriemalade.id
                   WHERE     (dbo.sortie.etatpaiement = 'Payé') and (convert(date,sortie.date,100) not in(select sortie.date from sortie)) and convert(date,hospitalisation.datefin,100)='03/08/2015' and dbo.categoriemalade.designation='Abonné'
                   ...
                   FROM         dbo.detailsautrefraie INNER JOIN dbo.autrefraie ON dbo.autrefraie.id = dbo.detailsautrefraie.id_autrefraie INNER JOIN
                                         dbo.malade ON dbo.malade.id = dbo.autrefraie.id_malade INNER JOIN 
                                          ...
                                          dbo.personne ON dbo.malade.id_personne = dbo.personne.id LEFT OUTER JOIN
                                         dbo.categoriemalade ON dbo.malade.id_categoriemalade = dbo.categoriemalade.id
                   WHERE     (dbo.autrefraie.etatpaiement = 'Payé') and (convert(date,autrefraie.dateenregistrement,100)='03/08/2015') and convert(date,hospitalisation.datefin,100)='03/08/2015' and dbo.categoriemalade.designation='Abonné'
                   ...
                   WHERE     ((dbo.hospitalisation.etatpaiement = 'Non cloturé payé') OR
                                         (dbo.hospitalisation.etatpaiement = 'Cloturé payé')) and convert(date,hospitalisation.datefin,100)='03/08/2015' and dbo.categoriemalade.designation='Abonné'
                   ...
                   WHERE     ((dbo.dossieravance.etatpaiement = 'Non cloturé payé') OR
                                         (dbo.dossieravance.etatpaiement = 'Cloturé payé')) and (convert(date,dossieravance.date,100)='03/08/2015') and convert(date,hospitalisation.datefin,100)='03/08/2015' and dbo.categoriemalade.designation='Abonné'
